...
impl JsonRpcTestHelper {
    ...
    pub fn get_tc_account_address() -> &'static str {
        "0000000000000000000000000b1e55ed"
    }
    pub fn get_tc_account_private_key() -> &'static str {
        "AAPBPRrI1tKC8jbB9eG+E0mX6pkX9LE3TljRvAiHsYpKeivyYLz7GY2eS2727jIdGekRuL+fo25Zrfyn5ViLSg=="
    }
    pub fn get_json_rpc_url() -> &'static str {
        "https://testnet.diem.com/v1"
    }
    pub fn get_mint_url() -> &'static str {
