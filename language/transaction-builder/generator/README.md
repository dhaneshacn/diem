...
Items (1) and (2) are provided by the Rust library `serde-generate` which is developed in a separate [github repository]({ git = "https://github.com/dhaneshacn/serde-reflection-diem.git"}).
